...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('financial_calculator.log'),
...
class FinancialCalculator(QMainWindow):
    ...
    def create_calculator_tab(self):
        ...
        self.tabs.addTab(calculator_tab, "Calculator")
    ...
    def create_future_value_group(self, parent_layout):
        ...
        self.amount_future_b.setPrefix("₹ ")
        ...
        group_layout.addWidget(self.fv_result_label)
    ...
    def create_npv_group(self, parent_layout):
        ...
        group_layout.addWidget(self.npv_result_label)
    ...
    def create_terminal_value_group(self, parent_layout):
        ...
        group_layout.addWidget(self.terminal_result_label)
    ...
    def create_fair_value_group(self, parent_layout):
        ...
        group_layout.addWidget(self.fair_value_result_label)
    ...
    def FvCalculator(self):
        ...
        try:
            ...
            error_msg = "Error in Future Value calculation. Please check your inputs."
    ...
    def FvCalculator_b(self):
        ...
        try:
            ...
            error_msg = "Error in Secondary Future Value calculation. Please check your inputs."
            QMessageBox.critical(self, "Calculation Error", error_msg)
    ...
    def Nv(self):
        ...
        try:
            ...
            result_text = (
                ...
                f"Present Values: {[f'₹{x:.2f}' for x in pvvaluelist]}\n"
                f"Total Present Value: ₹{self.sumofvalues:.2f}"
            )
            ...
            error_msg = "Error in NPV calculation. Please calculate Future Values first."
            QMessageBox.critical(self, "Calculation Error", error_msg)
    ...
    def TerminalValue(self):
        ...
        try:
            ...
            result_text = (
                ...
                f"Discount Rate: {discount_rate*100:.1f}%\n"
                f"Terminal Value: ₹{self.Terminal_Value:.2f}"
            )
            ...
            error_msg = "Error in Terminal Value calculation. Please complete previous steps first."
            QMessageBox.critical(self, "Calculation Error", error_msg)
    ...
    def PVcalculate(self):
        ...
        try:
            ...
            result_text = f"Present Value of Terminal Value: ₹{self.formula:.2f}"
            ...
            error_msg = "Error in PV calculation. Please calculate Terminal Value first."
            QMessageBox.critical(self, "Calculation Error", error_msg)
    ...
    def fairValue(self):
        ...
        try:
            ...
            result_text = (
                ...
                f"Fair Value per Share: ₹{FairValue:.2f}\n"
                f"Possible Valuation Range: ₹{possibleValuemin:.2f} to ₹{possibleValuemax:.2f}"
            )
            ...
            error_msg = "Error in Fair Value calculation. Please check your inputs."
            QMessageBox.critical(self, "Calculation Error", error_msg)
    ...
    def reset_button_click(self):
        ...
        try:
            # Reset input fields
            self.amount_future.setValue(0)
            self.operation_future.setValue(0)
            self.future_year_entry.setValue(1)
            self.amount_future_b.setValue(0)
            self.operation_future_b.setValue(0)
            self.future_year_entry_b.setValue(1)
            self.net_cash.setValue(0)
            self.shares.setValue(0)
            self.discount_rate.setValue(9.0)
            self.terminal_growth.setValue(3.5)
    ...
    def refresh_log(self):
        ...
        try:
            with open('financial_calculator.log', 'r') as log_file:
    ...
    def clear_log(self):
        """Clear the log file"""
        try:
            with open('financial_calculator.log', 'w'):
                pass
    ...
    def save_log(self):
        ...
        try:
            ...
            if file_name:
                with open('financial_calculator.log', 'r') as source, open(file_name, 'w') as target:
